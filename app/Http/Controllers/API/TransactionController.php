...
class TransactionController extends Controller
{
    public function all(Request $request) {
        ...
        if ($id) {
            ...
            if ($transaction) {
                return ResponseFormatter::success($transaction, 'Product was successfully loaded');
            } else {
        ...
        return ResponseFormatter::success(
            ...
            'Transaction list was successfully loaded',
        );
    }
    ...
    public function update(Request $request, $id) {
        ...
        return ReponseFormatter::success($transaction, 'Transaction was success updated');
    }
