              ...
              <form action="{{ route('users.store') }}" class="w-full" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap mx-3 mb-6">
                  <div class="w-full px-3">
                    ...
                    <input type="text" value="{{ old('name') }}" name="name" id="grid-last-name" class="appearance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="User Name">
                  </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
                  <div class="w-full px-3">
                    <label class="block uppercase tracking-wide text-grey-700 text-xs font-bold mb-2" for="grid-last-name">Email</label>
                    <input type="email" value="{{ old('email') }}" name="email" id="grid-last-name" class="appearance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Email">
                  </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
                  <div class="w-full px-3">
                ...
                <div class="flex flex-wrap mx-3 mb-6">
                  <div class="w-full px-3">
                    ...
                    <input type="text" value="{{ old('address') }}" name="address" id="grid-last-name" class="appearance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Address">
                  </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
                  <div class="w-full px-3">
                    <label class="block uppercase tracking-wide text-grey-700 text-xs font-bold mb-2" for="grid-last-name">House Number</label>
                    <input type="text" value="{{ old('houseNumber') }}" name="houseNumber" id="grid-last-name" class="appearance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="House Number">
                  </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
                  <div class="w-full px-3">
                    <label class="block uppercase tracking-wide text-grey-700 text-xs font-bold mb-2" for="grid-last-name">Phone Number</label>
                    <input type="text" value="{{ old('phoneNumber') }}" name="phoneNumber" id="grid-last-name" class="appearance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Phone Number">
                  </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
                  <div class="w-full px-3">
                    <label class="block uppercase tracking-wide text-grey-700 text-xs font-bold mb-2" for="grid-last-name">City</label>
                    <input type="text" value="{{ old('city') }}" name="city" id="grid-last-name" class="appearance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="City">
                  </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
